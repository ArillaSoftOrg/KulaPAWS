    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-3 rounded-lg border border-destructive/40 bg-surface p-4">
        ...
        <div className="flex items-center gap-3">
          <DestructiveConfirm
            message="Reset ALL local content (business info, homepage, about, services page, contact page, services, FAQs) and remove all locally stored images? This can't be undone."
            confirmWord="RESET"
            actionLabel="Reset All Local Content"
